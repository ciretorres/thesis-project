...
![](https://img.shields.io/badge/vite-v8.2.0-green)

Es una interfaz-interactiva lúdica que visualiza el fenómeno en asotronomía del módulo de distancia. Utiliza [three.js](https://threejs.org/) y [vite](https://vite.dev/) para presentarlo en el navegador [aquí](https://ciretorres.github.io/thesis-project/).
...
<img src="./static/capturas/Screen Shot 2026-08-31 at 19.11.46.webp" width="800">
...
- [Implementación](./src/assets/docs/implementacion.md)
  - Escena, Cámara, Renderer, Controles, Luces.
  - [Estrellas](./src/assets/docs/implementacion.md)
  - [Retícula](./src/assets/docs/implementacion.md#reticula) (Declinación, Ascensión Recta, [Etiquetas](./src/assets/docs/implementacion.md#etiquetas))
- [Three.js](#threejs)
...
El proyecto anterior de Processing se dejó de dar mantenimiento, debido a que se buscaba una mejor manera de hacerlo en un ambiente más abierto y controlado con frameworks o librerías flexibles y modernas o motores para el desarrollo de gráficos en 3D o videojuegos. 
