...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function jo(e,t,n){let r=new Float32Array(_o),i=new q(0,1,0);return new Zi({name:`SphericalGaussianBlur`,defines:{n:_o,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Po(),fragmentShader:`
	...
	`}var Fo=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Li(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,bl.append(xl),xl.querySelector(`.agregar-distancia`).addEventListener(`click`,()=>{Ll()});var Sl=xl.querySelector(`.btn-cerrar`);xl.querySelector(`.restar-distancia`).addEventListener(`click`,()=>{Rl()}),Sl.addEventListener(`click`,()=>{xl.style.display=`none`});var Cl=document.querySelector(`#titleid h2`),wl=document.querySelector(`#hipid`),Tl=document.querySelector(`#vmagid`),El=document.querySelector(`#absmagid`),Dl=document.querySelector(`#distanciaid`),Ol=document.querySelector(`#lyid`),kl=document.querySelector(`#rahmsid`),Al=document.querySelector(`#dedmsid`),jl=null,Ml=(e,t)=>{let n=new Ya,r=new K,i=null,a=e=>{e.material.color.set(16777215)},o=e=>{e!==jl&&e.material.color.set(16711680)},s=e=>{e.material.color.set(65280)},c=s=>{r.x=s.clientX/window.innerWidth*2-1,r.y=-(s.clientY/window.innerHeight)*2+1,n.setFromCamera(r,e);let c=n.intersectObject(t,!0);if(c.length>0){let e=c.filter(function(e){return e&&e.object})[0];i&&i!==e.object&&i!==jl&&a(i),o(e.object),i=e.object}else i&&i!==jl&&(a(i),i=null)};document.addEventListener(`pointermove`,c);let l={11767:`α Ursae Minoris (Polaris)`,85665:`SAO 122446`,70890:`Proxima Centauri`,71683:`α Centauri A (Rigil Kentaurus o Toliman)`,71681:`α Centauri B (Rigil Kentaurus o Toliman)`,87937:`Estrella de Barnard`,54035:`Lalande 21185`,32349:`α Canis Majoris (Sirio)`,92403:`Ross 154`,37279:`α Canis Minoris (Procyon)`,36208:`Estrella de Luyten`,24186:`Estrella de Kapteyn`,110893:`Kruger 60`,3829:`Estrella de Van Maanen`,97649:`α Aquilae (Altair)`,113368:`α Piscis Austrini (Fomalhaut)`,91262:`α Lyrae (Vega)`,56997:`61 Ursae Majoris`},u=i=>{r.x=i.clientX/window.innerWidth*2-1,r.y=-(i.clientY/window.innerHeight)*2+1,n.setFromCamera(r,e);let o=n.intersectObject(t,!0);if(o.length>0){let e=o[0].object;if(e===jl)a(e),xl.style.display=`none`,jl=null;else{jl&&a(jl),s(e),jl=e,Cl.innerText=l[jl.HIP]?l[jl.HIP]:`Estrella No encontrada`,wl.innerText=jl.HIP,Tl.innerText=jl.Vmag,El.innerText=jl.ABSmag.toFixed(2),Dl.innerText=jl.Pc.toFixed(2),Ol.innerText=(jl.Pc*3.261598).toFixed(2);let t=jl.RAhms.split(` `);kl.innerText=`${t[0]}h ${t[1]}m ${t[2]}s`;let n=jl.DEdms.split(` `);Al.innerText=`${n[0]}° ${n[1]}' ${n[2]}"`,xl.style.display=`block`}}else jl&&(xl.contains(i.target)?Sl.contains(i.target)&&(a(jl),jl=null):(a(jl),xl.style.display=`none`,jl=null))};return document.addEventListener(`click`,u),()=>{document.removeEventListener(`pointermove`,c),document.removeEventListener(`click`,u)}};function Nl(e,t){return Math.log10(t)*5-5+e}var Pl=document.querySelector(`#vmagid`),Fl=document.querySelector(`#distanciaid`),Il=document.querySelector(`#lyid`);document.addEventListener(`keydown`,function(e){if(jl){if(e.key===`+`){console.log(`+ key pressed`);let e=jl;e.Pc+=1,e.position.z+=1,e.Vmag=Nl(e.ABSmag,e.Pc),Pl.innerText=e.Vmag.toFixed(2),Fl.innerText=e.Pc.toFixed(2),Il.innerText=(e.Pc*3.261598).toFixed(2),console.log(e.HIP,e.Pc,e.position.z)}if(e.key===`-`){console.log(`- key pressed`);let e=jl;e.Pc>1&&(--e.Pc,--e.position.z),e.Vmag=Nl(e.ABSmag,e.Pc),Pl.innerText=e.Vmag.toFixed(2),Fl.innerText=e.Pc.toFixed(2),Il.innerText=(e.Pc*3.261598).toFixed(2),console.log(e.HIP,e.Pc,e.position.z)}}else console.log(`selecciona una estrella`)});var Ll=()=>{console.log(`+ button clicked`);let e=jl;e.Pc+=1,e.position.z+=1,e.Vmag=Nl(e.ABSmag,e.Pc),Pl.innerText=e.Vmag.toFixed(2),Fl.innerText=e.Pc.toFixed(2),Il.innerText=(e.Pc*3.261598).toFixed(2),console.log(e.HIP,e.Pc,e.position.z)},Rl=()=>{console.log(`- button clicked`);let e=jl;e.Pc>1&&(--e.Pc,--e.position.z),e.Vmag=Nl(e.ABSmag,e.Pc),Pl.innerText=e.Vmag.toFixed(2),Fl.innerText=e.Pc.toFixed(2),Il.innerText=(e.Pc*3.261598).toFixed(2),console.log(e.HIP,e.Pc,e.position.z)},zl=(e=50,t=1,n=1,r=2e3)=>new Da(e,t,n,r),Bl=(()=>{let e=zl(35,window.innerWidth/window.innerHeight,.1,1e3);return e.position.z=-1,e.layers.enableAll(),e})(),Vl={type:`change`},Hl={type:`start`},Ul={type:`end`},Wl=new $r,Gl=new yi,Kl=Math.cos(70*wt.DEG2RAD),ql=new q,Jl=2*Math.PI,$={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Yl=1e-6,Xl=class extends eo{constructor(n,r=null){super(n,r),this.state=$.NONE,this.target=new q,this.cursor=new q,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.DOLLY,RIGHT:e.PAN},this.touches={ONE:t.ROTATE,TWO:t.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new q,this._lastQuaternion=new Tt,this._lastTargetPosition=new q,this._quat=new Tt().setFromUnitVectors(n.up,new q(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Qa,this._sphericalDelta=new Qa,this._scale=1,this._panOffset=new q,this._rotateStart=new K,this._rotateEnd=new K,this._rotateDelta=new K,this._panStart=new K,this._panEnd=new K,this._panDelta=new K,this._dollyStart=new K,this._dollyEnd=new K,this._dollyDelta=new K,this._dollyDirection=new q,this._mouse=new K,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Ql.bind(this),this._onPointerDown=Zl.bind(this),this._onPointerUp=$l.bind(this),this._onContextMenu=ou.bind(this),this._onMouseWheel=nu.bind(this),this._onKeyDown=ru.bind(this),this._onTouchStart=iu.bind(this),this._onTouchMove=au.bind(this),this._onMouseDown=eu.bind(this),this._onMouseMove=tu.bind(this),this._interceptControlDown=su.bind(this),this._interceptControlUp=cu.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction=``}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Vl),this.update(),this.state=$.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;ql.copy(t).sub(this.target),ql.applyQuaternion(this._quat),this._spherical.setFromVector3(ql),this.autoRotate&&this.state===$.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=Jl:n>Math.PI&&(n-=Jl),r<-Math.PI?r+=Jl:r>Math.PI&&(r-=Jl),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(ql.setFromSpherical(this._spherical),ql.applyQuaternion(this._quatInverse),t.copy(this.target).add(ql),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=ql.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new q(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new q(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=ql.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):(Wl.origin.copy(this.object.position),Wl.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Wl.direction))<Kl?this.object.lookAt(this.target):(Gl.setFromNormalAndCoplanarPoint(this.object.up,this.target),Wl.intersectPlane(Gl,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>Yl||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Yl||this._lastTargetPosition.distanceToSquared(this.target)>Yl?(this.dispatchEvent(Vl),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?Jl/60/60*this.autoRotateSpeed:Jl/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){ql.setFromMatrixColumn(t,0),ql.multiplyScalar(-e),this._panOffset.add(ql)}_panUp(e,t){this.screenSpacePanning===!0?ql.setFromMatrixColumn(t,1):(ql.setFromMatrixColumn(t,0),ql.crossVectors(this.object.up,ql)),ql.multiplyScalar(e),this._panOffset.add(ql)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;ql.copy(r).sub(this.target);let i=ql.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(Jl*this._rotateDelta.x/t.clientHeight),this._rotateUp(Jl*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(Jl*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-Jl*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(Jl*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-Jl*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(Jl*this._rotateDelta.x/t.clientHeight),this._rotateUp(Jl*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new K,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function Zl(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function Ql(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function $l(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(Ul),this.state=$.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y})}}function eu(t){let n;switch(t.button){case 0:n=this.mouseButtons.LEFT;break;case 1:n=this.mouseButtons.MIDDLE;break;case 2:n=this.mouseButtons.RIGHT;break;default:n=-1}switch(n){case e.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(t),this.state=$.DOLLY;break;case e.ROTATE:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=$.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=$.ROTATE}break;case e.PAN:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=$.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=$.PAN}break;default:this.state=$.NONE}this.state!==$.NONE&&this.dispatchEvent(Hl)}function tu(e){switch(this.state){case $.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case $.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case $.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e)}}function nu(e){this.enabled!==!1&&this.enableZoom!==!1&&this.state===$.NONE&&(e.preventDefault(),this.dispatchEvent(Hl),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(Ul))}function ru(e){this.enabled!==!1&&this._handleKeyDown(e)}function iu(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case t.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=$.TOUCH_ROTATE;break;case t.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=$.TOUCH_PAN;break;default:this.state=$.NONE}break;case 2:switch(this.touches.TWO){case t.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=$.TOUCH_DOLLY_PAN;break;case t.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=$.TOUCH_DOLLY_ROTATE;break;default:this.state=$.NONE}break;default:this.state=$.NONE}this.state!==$.NONE&&this.dispatchEvent(Hl)}function au(e){switch(this._trackPointer(e),this.state){case $.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case $.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case $.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case $.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=$.NONE}}function ou(e){this.enabled!==!1&&e.preventDefault()}function su(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function cu(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}var lu=(e,t)=>new Xl(e,t),uu=(e,t)=>{let n=lu(e,t);return n.enableZoom=!0,n.enableDamping=!0,n},du=()=>new An,fu=(()=>{let e=du();return e.background=new X(0),e})(),pu=(e=16777215,t=.5)=>new Aa(e,t),mu=(e=4210752,t=1)=>new ja(e,t),hu=e=>{let t=new X(16777215),n=mu(t);e.add(n);let r=[];r.push(pu(t,3)),r[0].position.set(0,200,0),e.add(r[0])},gu=class{static isWebGL2Available(){try{let e=document.createElement(`canvas`);return!!(window.WebGL2RenderingContext&&e.getContext(`webgl2`))}catch{return!1}}static isColorSpaceAvailable(e){try{let t=document.createElement(`canvas`),n=window.WebGL2RenderingContext&&t.getContext(`webgl2`);return n.drawingBufferColorSpace=e,n.drawingBufferColorSpace===e}catch{return!1}}static getWebGL2ErrorMessage(){return this._getErrorMessage(2)}static _getErrorMessage(e){let t={1:`WebGL`,2:`WebGL 2`},n={1:window.WebGLRenderingContext,2:window.WebGL2RenderingContext},r=`Your $0 does not seem to support <a href="http://khronos.org/webgl/wiki/Getting_a_WebGL_Implementation" style="color:#000">$1</a>`,i=document.createElement(`div`);return i.id=`webglmessage`,i.style.fontFamily=`monospace`,i.style.fontSize=`13px`,i.style.fontWeight=`normal`,i.style.textAlign=`center`,i.style.background=`#fff`,i.style.color=`#000`,i.style.padding=`1.5em`,i.style.width=`400px`,i.style.margin=`5em auto 0`,r=n[e]?r.replace(`$0`,`graphics card`):r.replace(`$0`,`browser`),r=r.replace(`$1`,t[e]),i.innerHTML=r,i}},_u=(e,t,n,r)=>{if(gu.isWebGL2Available())e.setAnimationLoop(t),console.log(`es compatible con WebGL:`,gu.isWebGL2Available());else{document.querySelector(r).style.display=`none`;let e=gu.getWebGL2ErrorMessage();document.querySelector(n).appendChild(e);let t=document.createElement(`div`);t.innerHTML+=`
        ...
        </h2>`,document.querySelector(`#webglmessage`).appendChild(t),console.warn(`Tu tarjeta gráfica parece no soportar WebGL2`)}},vu=(e,t=!1,n=!0)=>e===void 0?new yl({alpha:t,antialias:n}):new yl({canvas:e,alpha:t,antialias:n}),yu=(e,t,n)=>{let r=document.querySelector(t),i=vu(document.querySelector(n));return i.domElement.id=`rendererid`,i.setSize(window.innerWidth,window.innerHeight),r.appendChild(i.domElement),_u(i,e,t,n),i},bu=e=>e*10,xu=(e,t)=>{e.HIP=t.HIP,e.RAhms=t.RAhms,e.DEdms=t.DEdms,e.Vmag=t.Vmag,e.ABSmag=t.ABSmag,e.Pc=t.Pc,e.Ly=t.Ly},Su=(e=1)=>{let t=new xn,n=new Wr(new Ar({color:16777215}));return n.material.color.set(`orange`),n.HIP=11767,n.RAhms=`02 31 47.08`,n.DEdms=`+89 15 50.9`,n.Vmag=1.97,n.ABSmag=-3.637391,n.Pc=132.275132,n.Ly=431.428307,n.position.set(1.3396481090837498,1.0446215486735597,132.2642231564061),n.scale.set(1,1,1),t.add(n),t},Cu=(e=[])=>{let t=new xn;e.forEach(e=>{let n=new Wr(new Ar({color:16777215})),r=bu(e.X),i=bu(e.Y),a=bu(e.Z);n.position.set(r,i,a),n.scale.set(1,1,1),xu(n,e),t.add(n)});let n=new Sn;return n=Su(),t.add(n),t},wu;new Sn;var Tu=({data:e=[]})=>{let t=new Sn;return wu=Cu(e),t.add(wu),t},Eu=e=>Math.PI/180*e,Du=(e=1,t,n)=>{let r=Eu(n),i=Eu(t);return new q(e*Math.cos(r)*Math.cos(i),e*Math.cos(r)*Math.sin(i),e*Math.sin(r))},Ou=(e=1,t=20,n=new X(`#4488ff`))=>{let r=new Sn;for(let i=-90;i<=90;i+=t){let t=[];for(let n=0;n<=360;n++){let r=Du(e,n,i),a=r.x,o=r.y,s=r.z;t.push(new q(a,o,s))}let a=new Ii(new wr().setFromPoints(t),new wi({color:n,transparent:!0,opacity:.6}));a.updateMatrix(),r.add(a)}return r},ku=(e=1,t=15,n=new X(`#4488ff`))=>{let r=new Sn,i=[0,90,180,270,360];for(let a=0;a<=360;a+=t){let t=i.includes(a)?90:80,o=[];for(let n=-t;n<=t;n++){let t=Du(e,a,n);o.push(t)}let s=new Ii(new wr().setFromPoints(o),new wi({color:n,transparent:!0,opacity:.6}));s.updateMatrix(),r.add(s)}return r},Au=({stepRa:e,stepDec:t,radius:n=1,color:r=new X(`#4488ff`),coordinates:i=`all`})=>{let a=new Sn,o=r,s=r;if(i==`declination`)return a=Ou(n,t,o),a;if(i===`ascension`)return a=ku(n,e,s),a;{let r=ku(n,e,s);a.add(r);let i=Ou(n,t,o);return a.add(i),a}},ju=class extends xn{constructor(e=document.createElement(`div`)){super(),this.isCSS2DObject=!0,this.element=e,this.element.style.position=`absolute`,this.element.style.userSelect=`none`,this.element.setAttribute(`draggable`,!1),this.center=new K(.5,.5),this.addEventListener(`removed`,function(){this.traverse(function(e){e.element&&e.element instanceof e.element.ownerDocument.defaultView.Element&&e.element.parentNode!==null&&e.element.remove()})})}copy(e,t){return super.copy(e,t),this.element=e.element.cloneNode(!0),this.center=e.center,this}},Mu=new q,Nu=new qt,Pu=new qt,Fu=new q,Iu=new q,Lu=class{constructor(e={}){let t=this,n,r,i,a,o={objects:new WeakMap},s=e.element===void 0?document.createElement(`div`):e.element;s.style.overflow=`hidden`,this.domElement=s,this.sortObjects=!0,this.getSize=function(){return{width:n,height:r}},this.render=function(e,t){e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),Nu.copy(t.matrixWorldInverse),Pu.multiplyMatrices(t.projectionMatrix,Nu),l(e,e,t),this.sortObjects&&f(e)},this.setSize=function(e,t){n=e,r=t,i=n/2,a=r/2,s.style.width=e+`px`,s.style.height=t+`px`};function c(e){e.isCSS2DObject&&(e.element.style.display=`none`);for(let t=0,n=e.children.length;t<n;t++)c(e.children[t])}function l(e,n,r){if(e.visible===!1){c(e);return}if(e.isCSS2DObject){Mu.setFromMatrixPosition(e.matrixWorld),Mu.applyMatrix4(Pu);let c=Mu.z>=-1&&Mu.z<=1&&e.layers.test(r.layers)===!0,l=e.element;l.style.display=c===!0?``:`none`,c===!0&&(e.onBeforeRender(t,n,r),l.style.transform=`translate(`+-100*e.center.x+`%,`+-100*e.center.y+`%)translate(`+(Mu.x*i+i)+`px,`+(-Mu.y*a+a)+`px)`,l.parentNode!==s&&s.appendChild(l),e.onAfterRender(t,n,r));let d={distanceToCameraSquared:u(r,e)};o.objects.set(e,d)}for(let t=0,i=e.children.length;t<i;t++)l(e.children[t],n,r)}function u(e,t){return Fu.setFromMatrixPosition(e.matrixWorld),Iu.setFromMatrixPosition(t.matrixWorld),Fu.distanceToSquared(Iu)}function d(e){let t=[];return e.traverseVisible(function(e){e.isCSS2DObject&&t.push(e)}),t}function f(e){let t=d(e).sort(function(e,t){return e.renderOrder===t.renderOrder?o.objects.get(e).distanceToCameraSquared-o.objects.get(t).distanceToCameraSquared:t.renderOrder-e.renderOrder}),n=t.length;for(let e=0,r=t.length;e<r;e++)t[e].element.style.zIndex=n-e}}},Ru=(e,t)=>{let n=document.createElement(`div`);n.className=`wrapper-label`;let r=document.createElement(`div`);r.id=`labelid-${Math.random().toString(36).substring(2)}`,r.className=`label`,r.textContent=`${e}`,n.appendChild(r);let i=new ju(n);return i.position.copy(t),i.center.set(0,1),i},zu=new Sn;((e=1,t=15)=>{let n=new Sn,r=[0,90,180,270,360],i=[-90,-80,-70,-50,-30,-10,0,10,30,50,70,80,90],a=[-80,-70,-50,-30,-10,0,10,30,50,70,80];for(let n=0;n<=360;n+=t){let t=r.includes(n),o=t?90:80,s=t?i:a,c=n/15;for(let t=-o;t<=o;t++)if(s.includes(t)&&[30,60,90,120,150,180,210,240,270,300,330,360].includes(n)&&(n===180||t!==90)&&t!==-90){let r=Du(e,n,t),i=Ru(`${t>=0?`+`:``}${t}° | ${c}h`,r);zu.add(i)}}return n})();var Bu=new Sn,Vu=1,Hu=new X(`#4488ff`),Uu=(e=`ecuatorial`)=>{let t=new Sn;return e===`ecuatorial`&&(t=Au({stepRa:15,stepDec:10,radius:Vu,color:Hu})),t},Wu=({radio:e=1,color:t=new X(`#ff0000`)})=>{let n=new Sn;Vu=e,Hu=t;let r=Uu();return n.add(r),Bu=zu,n.add(Bu),n},Gu=()=>new Lu,Ku=e=>{let t=document.querySelector(e),n=Gu();return n.setSize(window.innerWidth,window.innerHeight),n.domElement.id=`css2drendererid`,n.domElement.style.position=`absolute`,n.domElement.style.top=`0px`,n.domElement.style.pointerEvents=`none`,t.appendChild(n.domElement),n},qu=(e,t,n)=>{e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix(),t.setSize(window.innerWidth,window.innerHeight),n.setSize(window.innerWidth,window.innerHeight)},Ju=(e,t,n)=>{window.addEventListener(`resize`,()=>qu(e,t,n),!1)},Yu=(e,t)=>{e.updateMatrixWorld();let n=new Ci;n.setFromProjectionMatrix(new qt().multiplyMatrices(e.projectionMatrix,e.matrixWorldInverse));let r=[];return t.children.forEach(e=>{n.containsPoint(e.position)?(e.visible=!0,r.push(e)):e.visible=!1}),r},Xu=(e,t,n)=>e.x!==t.position.x||e.y!==t.position.y||e.z!==t.position.z?(n.position.set(t.position.x,t.position.y,t.position.z),{x:t.position.x,y:t.position.y,z:t.position.z}):{x:e.x,y:e.y,z:e.z};async function Zu(){let e=[];try{let t=await fetch(`../notebooks/data_clean/vizier_I_239_hip_main_10pc.json`);if(!t.ok)throw Error(`Network response was not ok`,t.status);return e=(await t.json()).data,e}catch(e){console.error(`Error: ${e.message}`)}}var Qu=e=>{let t=new $a(5);t.layers.enableAll(),e.add(t)},$u=function(){var e=0,t=document.createElement(`div`);t.style.cssText=`position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000`,t.addEventListener(`click`,function(n){n.preventDefault(),r(++e%t.children.length)},!1);function n(e){return t.appendChild(e.dom),e}function r(n){for(var r=0;r<t.children.length;r++)t.children[r].style.display=r===n?`block`:`none`;e=n}var i=(performance||Date).now(),a=i,o=0,s=n(new $u.Panel(`FPS`,`#0ff`,`#002`)),c=n(new $u.Panel(`MS`,`#0f0`,`#020`));if(self.performance&&self.performance.memory)var l=n(new $u.Panel(`MB`,`#f08`,`#201`));return r(0),{REVISION:16,dom:t,addPanel:n,showPanel:r,begin:function(){i=(performance||Date).now()},end:function(){o++;var e=(performance||Date).now();if(c.update(e-i,200),e>=a+1e3&&(s.update(o*1e3/(e-a),100),a=e,o=0,l)){var t=performance.memory;l.update(t.usedJSHeapSize/1048576,t.jsHeapSizeLimit/1048576)}return e},update:function(){i=this.end()},domElement:t,setMode:r}};$u.Panel=function(e,t,n){var r=1/0,i=0,a=Math.round,o=a(window.devicePixelRatio||1),s=80*o,c=48*o,l=3*o,u=2*o,d=3*o,f=15*o,p=74*o,m=30*o,h=document.createElement(`canvas`);h.width=s,h.height=c,h.style.cssText=`width:80px;height:48px`;var g=h.getContext(`2d`);return g.font=`bold `+9*o+`px Helvetica,Arial,sans-serif`,g.textBaseline=`top`,g.fillStyle=n,g.fillRect(0,0,s,c),g.fillStyle=t,g.fillText(e,l,u),g.fillRect(d,f,p,m),g.fillStyle=n,g.globalAlpha=.9,g.fillRect(d,f,p,m),{dom:h,update:function(c,_){r=Math.min(r,c),i=Math.max(i,c),g.fillStyle=n,g.globalAlpha=1,g.fillRect(0,0,s,f),g.fillStyle=t,g.fillText(a(c)+` `+e+` (`+a(r)+`-`+a(i)+`)`,l,u),g.drawImage(h,d+o,f,p-o,m,d,f,p-o,m),g.fillRect(d+p-o,f,o,m),g.fillStyle=n,g.globalAlpha=.9,g.fillRect(d+p-o,f,o,a((1-c/_)*m))}}};var ed=e=>{let t=new $u;return document.querySelector(e).appendChild(t.dom).setAttribute(`id`,`statsid`),document.querySelector(`#statsid`).setAttribute(`style`,`position: absolute; top: 0px; right: 0px; cursor: pointer; opacity: 0.9; z-index: 10000;`),t},td,nd,rd,id,ad,od,sd,cd;ld();async function ld(){cd=await Zu(),e();function e(){sd=ed(`#mainid`),od=fu,td=Bl,rd=yu(o,`#mainid`,`#canvasid`),id=Ku(`#mainid`),ad=uu(td,rd.domElement),ad.update(),hu(od),Qu(od);let e=new Sn,t=Tu({data:cd});e.add(t);let n=new Sn,r=Wu({radio:1});nd={x:td.position.x,y:td.position.y,z:td.position.z},r.position.set(0,0,td.position.z),n.add(r);let i=new Sn;i.add(e),i.add(n),od.add(i),Ml(td,e);function a(){window.requestAnimationFrame(a),nd=Xu(nd,td,r),rd.render(od,td),id.render(od,td)}Ju(td,rd,id);function o(t){Yu(td,e),Yu(td,r),ad.update(),a(),document.querySelector(`#idx`).innerText=`x: ${td.position.x.toFixed(2)}`,document.querySelector(`#idy`).innerText=`y: ${td.position.y.toFixed(2)}`,document.querySelector(`#idz`).innerText=`z: ${td.position.z.toFixed(2)}`,sd.update()}}}var ud=()=>td,dd=document.querySelector(`#mainid`),fd=document.createElement(`div`);fd.id=`contenedorcontrolesid`,fd.className=`contenedor-controles`,fd.innerHTML=`
...
`,dd.append(fd),fd.querySelector(`#botontogglecontrolesid`).addEventListener(`click`,()=>{hd()});var pd=document.createElement(`div`);pd.id=`dialogid`,pd.className=`modal-instructivo`,pd.innerHTML=`
  <h2>¡Bienvenido!</h2>
  <p>
...
`,dd.append(pd);var md=!1,hd=()=>{md?(pd.style.display=`none`,md=!1):(pd.style.display=`block`,md=!0)},gd=e=>{e.position.z+=5},_d=e=>{e.position.z-=5},vd=e=>{e.position.x=0,e.position.y=0,e.position.z=-1};document.addEventListener(`keydown`,function(e){e.key===`w`&&(console.log(`W key pressed`),gd(ud())),e.key===`s`&&(console.log(`S key pressed`),_d(ud())),e.key===`a`&&(console.log(`A key pressed`),ud().position.x-=5),e.key===`d`&&(console.log(`D key pressed`),ud().position.x+=5),e.key===`q`&&(console.log(`Q key pressed`),ud().position.y-=5),e.key===`e`&&(console.log(`E key pressed`),ud().position.y+=5),e.key===`Enter`&&(console.log(`Enter key pressed`),vd(ud()))});var yd=()=>{console.log(`imprimió`)};yd(),window.imprime=yd,document.addEventListener(`keydown`,function(e){e.key===`Escape`&&(console.log(`Escape key pressed`),document.querySelector(`#tarjetainfoid`).style.display===`block`&&(document.querySelector(`#tarjetainfoid`).style.display=`none`),document.querySelector(`#dialogid`).style.display===`block`&&(document.querySelector(`#dialogid`).style.display=`none`))});
//# sourceMappingURL=index-BksGKt2B.js.map